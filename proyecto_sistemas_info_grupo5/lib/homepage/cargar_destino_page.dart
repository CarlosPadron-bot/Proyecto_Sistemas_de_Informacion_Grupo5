...
class _CargarDestinoPageState extends State<CargarDestinoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Container(
          constraints: const BoxConstraints(maxWidth: 600), // <<< CORRECCIÓN AQUÍ
              ...
              child: Column(
                ...
                children: [
                  const Text(
                    ...
                    style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFF009933)),
                    textAlign: TextAlign.center,
                  ),
                  const SizedBox(height: 20),
                  TextFormField(
                    controller: _nombreController,
                    decoration: const InputDecoration(labelText: 'Nombre del Destino (ej. Morrocoy)', border: OutlineInputBorder()),
                    validator: (v) => v!.isEmpty ? 'Campo obligatorio' : null,
                  ),
                  const SizedBox(height: 15),
                  TextFormField(
                    controller: _ubicacionController,
                    decoration: const InputDecoration(labelText: 'Ubicación / Estado', border: OutlineInputBorder()),
                    validator: (v) => v!.isEmpty ? 'Campo obligatorio' : null,
                  ),
                  const SizedBox(height: 15),
                  TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'Precio Estimado (\$ USD)', border: OutlineInputBorder(), prefixText: '\$ '),
                    validator: (v) {
                  ...
                  TextFormField(
                    ...
                    maxLines: 3,
                    decoration: const InputDecoration(labelText: 'Descripción de la opción sustentable', border: OutlineInputBorder()),
                    validator: (v) => v!.isEmpty ? 'Campo obligatorio' : null,
                  ),
                  const SizedBox(height: 15),
                  TextFormField(
                  ...
                  ElevatedButton(
                    ...
                    child: _cargando 
                        ...
                        : const Text('Subir a EcoRutas', style: TextStyle(fontSize: 16, color: Colors.white)),
                  ),
                ],
              ),
            ),
